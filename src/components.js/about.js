      ...
      <div className="md:flex md:flex-col md:items-center">
        ...
        <div className="w-full md:w-1/2 md:pl-6">
          <p className="text-lg leading-relaxed text-center md:text-left">
            ...
            beautiful, efficient, and user-friendly applications. I have
            experience in various modern web technologies such as React,
            Node.js, and Tailwind CSS. In my spare time, I enjoy learning new
            programming languages and exploring the latest trends in software
            development.
          </p>
        </div>
      </div>
